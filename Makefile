...
#    Updated: 2022/10/17 17:50:53 by dlopez-i         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_calloc.c ft_bzero.c ft_isalpha.c ft_isalnum.c ft_isascii.c  ft_isdigit.c ft_isprint.c ft_memchr.c \
